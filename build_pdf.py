...
ACTION = {1: "Load is arriving before generation, and the rules on who pays are being written without a way to measure it",
          ...
          3: "Integrating the conversion technology into the feedstock supply chain is what makes firm low-carbon power affordable",
...
EXHIBITS = [("Storing the captured tonne and keeping the claim is the only route to a low figure", "src/figures.py; per tonne of fossil methanol, kgCO₂e; 95 % capture; fuel factor IRENA (2021), illustrative", "Carbon flow per tonne of methanol under two CO₂ end uses"),
            ...
            ("The same plant reports 251 or 708 kgCO₂e/MWh depending on CO₂ end use and claim holder", "src/feedstock_ci.py. Note: stoichiometry 1.374 t CO₂ per t methanol; 55 % LHV efficiency, 95 % capture, 6 % parasitic; fuel factors IRENA (2021), illustrative", "Electricity carbon intensity by feedstock, CO₂ end use and claim holder, kgCO₂e per MWh, well to plug"),
            ("The product pays for the firm supply: 45–115 $/MWh for CO₂ as feedstock, 150–300 for solid carbon; durability decides only what the power may claim", "src/feedstock_ci.py coproduct_value() and turquoise_value(); 0.46 t CO₂ or 0.16 t solid carbon per MWh; price ranges IEA (2019), industry price reports and 2025 removal offtakes, illustrative", "Two conversion routes, their products, value per MWh, what they displace, and the claim on the electricity"),
...
KEY = ["The same on-site power plant reports 251 or 708 kgCO₂e/MWh depending on one clause in the CO₂ offtake contract.",
       "Integrate the conversion technology into the feedstock supply chain: CO₂ from reforming with capture is worth 45–115 $/MWh as industrial feedstock, solid carbon from methane pyrolysis 150–300; the product funds the firm supply, and durability decides only what the power may claim.",
