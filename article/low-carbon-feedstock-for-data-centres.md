...
Section 2 treated the plant as a power source with an accounting problem attached. That is the wrong frame for the technologies now arriving, and it is the frame that makes on-site low-carbon power look unaffordable. The better frame is the supply chain: the data centre's fuel is converted on or near the site by a process that yields energy and an industrial product, and the product goes into someone else's supply chain as a feedstock. Two technologies do this today, and the paper treats both.

**Technology 1: liquid-fuel reforming with integrated capture.** This is the unit of section 2. Methanol comes in; hydrogen goes to a fuel cell; a stream of pure, pressure-ready CO₂ comes out, about 0.46 tonnes per MWh of electricity. Pure CO₂ is a feedstock for food and beverage, greenhouses, dry ice, methanol and urea synthesis, e-fuels, and carbonated building materials. **Technology 2: turquoise hydrogen.** Methane pyrolysis splits the fuel into hydrogen and solid carbon and never makes CO₂ at the plant at all; the carbon leaves as a solid product, not as a gas. Per MWh of electricity from that hydrogen the plant yields roughly 0.16 tonnes of solid carbon, which is carbon black at the low end and graphite or nanocarbon at the high end, feedstocks for tyres, batteries, composites and concrete.
...
**What is already known.** The literature on this question is short and recent. Bjørn and colleagues showed in 2022 that renewable energy certificates let companies overstate emission reductions and that their use against science-based targets inflates reported progress [22]. Xu, Ricks, Jenkins and colleagues at Princeton found in 2024 that among voluntary procurement strategies only hourly matching consistently lowered system-wide emissions, and that annual matching had minimal long-run effect [23]. Riepin and Brown reached a similar result for the European grid with a capacity-expansion model, with the benefit appearing only above a threshold share of matched hours [24]. WattTime and others have argued the opposite side: that hourly matching without additionality does little, and that its cost could suppress procurement overall [25]. None of these studies places a specific AI load in a specific queue, prices its residual against the tariffs now being written, or asks who pays. That is the gap the pilot below and the research in section 6 address.
...
22. Bjørn, A., Lloyd, S. M., Brander, M. and Matthews, H. D., "Renewable energy certificates threaten the integrity of corporate science-based targets," *Nature Climate Change* 12, 539–546 (2022); and Bjørn et al., "Renewable energy certificates allow companies to overstate their emission reductions," *Nature Climate Change* 12 (2022).
23. Xu, Q., Ricks, W., Manocha, A., Patankar, N. and Jenkins, J. D., "System-level impacts of voluntary carbon-free electricity procurement strategies," *Joule* 8 (2024); Princeton ZERO Lab working paper (2023), zenodo.org/records/8325964.
24. Riepin, I. and Brown, T., "On the means, costs, and system-level impacts of 24/7 carbon-free energy procurement," *Energy Strategy Reviews* 54, 101488 (2024).
25. WattTime, "Impact accounting and hourly matching: a review" (2025) and related analyses on hourly matching without additionality; watttime.org.
